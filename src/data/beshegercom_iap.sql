...
--
-- Host: localhost
-- Generation Time: Feb 23, 2023 at 03:07 AM
...
INSERT INTO `audit_checklist` (`a_o_id`, `c_id`, `checking_point`, `check_objectives`, `riks`, `controls`) VALUES
(2, 1, 'Data storage System', 'Readiness', 'Decission', 'system');
...
--
-- Dumping data for table `audit_eng`
--

INSERT INTO `audit_eng` (`plan_id`, `message`, `assignment_date`, `team_id`, `enagement_status`, `contact_person`) VALUES
(3, 'Please PRepare', '2023-02-04', 1, 0, 9);
...
--
-- Dumping data for table `audit_finding`
--

INSERT INTO `audit_finding` (`plan_id`, `finding_id`, `finding_descriotion`, `criateria`, `impact`, `recomendation`, `registered_by`, `reg_date`, `auditees_id`, `auditee_response`, `response_date`, `rectification_status`, `rectification_date`, `report_date`, `rectification_confirmed`, `inReport`, `auditors_justification`) VALUES
(3, 1, 'this is finding Description', 'this is criteria', 'this is the impact', 'this is the recommendations ', 9, '2023-02-04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 1, 'IT service management', 'IT service Management audit'),
(2, 1, 'MIS', 'Managemmnt Infomration System'),
(4, 1, 'service Oprations', 'IT service Oprations'),
(5, 1, 'service Oprations', 'IT service Oprations'),
(6, 1, 'service Oprations', 'IT service Oprations'),
(7, 1, 'service Oprations', 'IT service Oprations'),
(8, 1, 'service Oprations', 'IT service Oprations');
...
--
-- Dumping data for table `audit_objectives`
--

INSERT INTO `audit_objectives` (`object_id`, `objective_id`, `objecive`) VALUES
(1, 1, 'Service Resilnce'),
(1, 2, 'Avialabilty'),
(2, 5, 'Ensure the ');
...
(3, 1, 8, 5, 1, NULL, NULL, NULL, '2022-07-01', '2023-07-01', NULL, NULL, NULL, NULL, NULL),
(6, 1, 2, 2, 1, 1, 3, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 4, 7, 2, 4, 1, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 4, 7, 2, 4, 1, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 4, 7, 2, 4, 1, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 4, 7, 2, 4, 1, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 4, 7, 2, 4, 1, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `audit_program` (`plan_id`, `previous_audit_status`, `scope`, `methodology`, `general_objectives`, `submited_by`, `submission`, `isApproved`, `start_date`, `end_date`, `total_date`) VALUES
(3, 'adgdffg', 'dgadfgdfg', 'adgdafgdfag', 'aadfgafgdafg', NULL, '2023-02-04', 0, '2023-02-04', '2023-03-04', 30);
...
--
-- Dumping data for table `engagement_to_audtees`
--

INSERT INTO `engagement_to_audtees` (`emp_id`, `program_id`) VALUES
(12, 3);
...
--
-- Dumping data for table `engagement_to_ou`
--

INSERT INTO `engagement_to_ou` (`ou_id`, `program_id`) VALUES
(7, 3);
...
--
-- Dumping data for table `program_activity`
--

INSERT INTO `program_activity` (`activity_id`, `p_id`, `auditable_area`, `start_date`, `end_date`) VALUES
(1, 3, 0, '2023-02-04', '2023-02-06');
...
--
-- Dumping data for table `p_o_m`
--

INSERT INTO `p_o_m` (`plan_id`, `obj_id`) VALUES
(3, 2);
...
CREATE TABLE `utable` (
  ...
  `count_x` int DEFAULT NULL,
  `pswd` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
INSERT INTO `utable` (`user_id`, `user_name`, `is_active`, `count_x`, `pswd`) VALUES
(7, 'yohannes ', 1, 0, '123123');
